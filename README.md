...
Um pouquinho sobre mim: 
   ...
   . 💻  **Desenvolvedor Full Stack Pleno** na Simova;
   . 🚀  Focado em arquiteturas reativas, microsserviços, qualidade de código e DevOps;
...
Nesse momento:
   ...
   . ☕  **Back-end:** Desenvolvendo soluções robustas com **Java (Spring Boot)** e **PHP (Symfony, Laravel)**;
   . 🟢  **Front-end:** Construindo interfaces modernas e reativas com **Vue.js** (Vue Router, Pinia/Vuex, Vuetify);
   . 🐳  **DevOps & Infra:** Padronizando ambientes e deploys com **Docker, Docker Compose, Devcontainers e CI/CD**;
   . 🛒  **Projeto Ativo:** Mantendo em produção o **iZi PDV** (Java Spring + PostgreSQL + Vue.js + Docker) com deploy automatizado e cliente real ativo;
...
<a href="https://github.com/LucasCosta0117">
    ...
    <div style="display: inline_block">
        ...
        <img align="center" alt="Symfony" height="30" width="40" src="https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/symfony/symfony-original.svg" />
...
<div>
  ...
  <a href="https://lucascosta0117.github.io/Tech-Academy_-_Desafio-Portifolio/" target="_blank"><img alt="Portfolio" src="https://img.shields.io/badge/website-000000?style=for-the-badge&logo=About.me&logoColor=white"></a>
</div><br>
